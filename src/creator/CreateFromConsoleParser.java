...
public class CreateFromConsoleParser {
    ...
    private static final String PERSON_FIELDS = "person name, coordinates x, coordinates y, person height, person weight, person passportID, person color,location x, location y, location z, location name";
